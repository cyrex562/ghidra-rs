//! Port of `ghidra.program.util.FunctionPurgeFieldLocation`.
//!
...
//! `FunctionPurgeFieldLocation(program, addr, charOffset)`, forwards to `ProgramLocation`'s public
...
/// A `ProgramLocation` for the function purge field.
///
/// Port of `ghidra.program.util.FunctionPurgeFieldLocation`.
pub trait FunctionPurgeFieldLocation: ProgramLocation {}
...
mod tests {
    ...
    struct FixedFunctionPurgeFieldLocation {
        address: Address,
        char_offset: i32,
    }

    impl ProgramLocation for FixedFunctionPurgeFieldLocation {
    ...
    impl FunctionPurgeFieldLocation for FixedFunctionPurgeFieldLocation {}
    ...
    fn trait_object_carries_address_and_char_offset_with_row_and_col_zeroed() {
        ...
        let loc: Box<dyn FunctionPurgeFieldLocation> =
            Box::new(FixedFunctionPurgeFieldLocation { address: addr.clone(), char_offset: 2 });
