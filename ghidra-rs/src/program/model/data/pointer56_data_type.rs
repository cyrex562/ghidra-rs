...
mod tests {
    ...
    impl DataOrganization for MockDataOrganization {
        ...
        fn get_pointer_size(&self) -> i32 {
            // Deliberately different from POINTER56_LENGTH, so tests can confirm the *stored*
            // fixed length (7) wins over whatever the data organization's native pointer size is.
            8
        }
