...
pub trait UnsignedLongDataType: AbstractUnsignedIntegerDataType {
    ...
    fn unsigned_long_c_type_declaration(&self, data_organization: Option<&dyn DataOrganization>) -> Option<String> {
...
mod tests {
    ...
    impl DataType for MockUnsignedLongDataType {
        ...
        fn get_data_organization(&self) -> Box<dyn DataOrganization> {
            Box::new(MockDataOrganization { long_size: self.long_size })
        }
    }
