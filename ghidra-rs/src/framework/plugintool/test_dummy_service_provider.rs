...
/// A dummy service provider for testing purposes.
///
/// Mirrors `ghidra.framework.plugintool.TestDummyServiceProvider`.
/// This is a minimal implementation that implements the ServiceProvider trait
/// but does not provide any actual services.
pub struct TestDummyServiceProvider;

impl ServiceProvider for TestDummyServiceProvider {
...
mod tests {
    ...
    fn get_service_always_returns_none() {
        let provider = TestDummyServiceProvider;
    ...
    fn add_service_listener_is_no_op() {
        let mut provider = TestDummyServiceProvider;
    ...
    fn provider_is_send_sync() {
        ...
        assert_send::<TestDummyServiceProvider>();
        assert_sync::<TestDummyServiceProvider>();
    }
}
