...
mod tests {
    ...
    fn known_hmac_sha1_vector() {
        ...
        // HMAC-SHA1("Jefe", "") verified against reference implementations.
        let expected = [
            0x09, 0xd9, 0xe5, 0x9d, 0x72, 0x23, 0x9e, 0x62, 0xa8, 0x15, 0x5c, 0x58, 0x3d, 0x52,
            0x74, 0x3d, 0xe9, 0xb7, 0x23, 0x1a,
        ];
