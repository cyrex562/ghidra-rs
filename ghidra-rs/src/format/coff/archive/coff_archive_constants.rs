/// Magic string that identifies a COFF archive file.
pub const MAGIC: &str = "!<arch>\n";

/// Length of the COFF archive magic string in bytes.
pub const MAGIC_LEN: usize = MAGIC.len();

/// Raw bytes of the COFF archive magic string.
