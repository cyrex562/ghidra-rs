...
/// The v4.00 version of [`SectionContribution`] for Microsoft PDB.
#[derive(Debug, Clone, Default)]
pub struct SectionContribution400 {
    isect: u16,
    offset: i32,
    length: i32,
    characteristics: u32,
...
impl SectionContribution400 {
    /// Creates a new, empty `SectionContribution400`.
    pub fn new() -> Self {
        SectionContribution400::default()
    }
}

impl SectionContribution for SectionContribution400 {
    fn section(&self) -> u16 {
        self.isect
    }
...
mod tests {
    ...
    fn deserialize_parses_all_fields() {
        ...
        let mut record = SectionContribution400::new();
    ...
    fn dump_contains_expected_fields() {
        ...
        assert!(output.starts_with("SectionContribution400"));
        ...
        assert!(output.contains("End SectionContribution400"));
