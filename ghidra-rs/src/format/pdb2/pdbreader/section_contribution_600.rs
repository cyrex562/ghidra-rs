...
/// The v6.00 version of [`SectionContribution`] for Microsoft PDB.
#[derive(Debug, Clone, Default)]
pub struct SectionContribution600 {
    isect: u16,
    offset: i32,
    length: i32,
    characteristics: u32,
...
impl SectionContribution600 {
    /// Creates a new, empty `SectionContribution600`.
    pub fn new() -> Self {
        SectionContribution600::default()
    }
}

impl SectionContribution for SectionContribution600 {
    fn section(&self) -> u16 {
        self.isect
    }
...
mod tests {
    ...
    fn deserialize_parses_all_fields() {
        ...
        let mut record = SectionContribution600::new();
    ...
    fn dump_contains_expected_fields() {
        ...
        assert!(output.starts_with("SectionContribution600"));
        ...
        assert!(output.contains("End SectionContribution600"));
