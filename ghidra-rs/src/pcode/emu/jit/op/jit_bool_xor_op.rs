//! A use-def node for a BOOL_XOR p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitBoolXorOp`.
...
/// A use-def node for the [`OpCode::BoolXor`] p-code operation.
///
/// Port of the Java record `JitBoolXorOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
/// implements JitBoolBinOp`.
///
/// # Differences from Java
///
/// Java's record automatically implements `JitBoolBinOp`'s inherited default
...
impl JitDefOp for JitBoolXorOp {
...
impl JitBinOp for JitBoolXorOp {
...
impl JitBoolBinOp for JitBoolXorOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::BoolXor, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitBoolXorOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::BoolXor);
    }
