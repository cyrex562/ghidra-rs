//! A use-def node for a FLOAT_LESS p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitFloatLessOp`.
...
/// A use-def node for the [`OpCode::FloatLess`] p-code operation.
///
/// Port of the Java record `JitFloatLessOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitFloatLessOp {
...
impl JitBinOp for JitFloatLessOp {
...
impl JitFloatBinOp for JitFloatLessOp {}
impl JitFloatTestOp for JitFloatLessOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::FloatLess, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitFloatLessOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::FloatLess);
    }
