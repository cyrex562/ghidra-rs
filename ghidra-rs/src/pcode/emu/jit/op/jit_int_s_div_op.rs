//! A use-def node for a INT_SDIV p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntSDivOp`.
...
/// A use-def node for the [`OpCode::IntSdiv`] p-code operation.
///
/// Port of the Java record `JitIntSDivOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitIntSDivOp {
...
impl JitBinOp for JitIntSDivOp {
...
impl JitIntBinOp for JitIntSDivOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntSdiv, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntSDivOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntSdiv);
    }
