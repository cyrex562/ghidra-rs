//! A use-def node for a FLOAT_SUB p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitFloatSubOp`.
...
/// A use-def node for the [`OpCode::FloatSub`] p-code operation.
///
/// Port of the Java record `JitFloatSubOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitFloatSubOp {
...
impl JitBinOp for JitFloatSubOp {
...
impl JitFloatBinOp for JitFloatSubOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::FloatSub, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitFloatSubOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::FloatSub);
    }
