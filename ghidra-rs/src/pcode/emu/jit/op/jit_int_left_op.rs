//! A use-def node for a INT_LEFT p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntLeftOp`.
...
/// A use-def node for the [`OpCode::IntLeft`] p-code operation.
///
/// Port of the Java record `JitIntLeftOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitIntLeftOp {
...
impl JitBinOp for JitIntLeftOp {
...
impl JitIntBinOp for JitIntLeftOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntLeft, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntLeftOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntLeft);
    }
