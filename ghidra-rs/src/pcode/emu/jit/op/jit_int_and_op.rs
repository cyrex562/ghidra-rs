//! A use-def node for a INT_AND p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntAndOp`.
...
/// A use-def node for the [`OpCode::IntAnd`] p-code operation.
///
/// Port of the Java record `JitIntAndOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitIntBinOp for JitIntAndOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntAnd, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntAndOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntAnd);
    }
