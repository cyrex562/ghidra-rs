//! A use-def node for a FLOAT_EQUAL p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitFloatEqualOp`.
...
/// A use-def node for the [`OpCode::FloatEqual`] p-code operation.
///
/// Port of the Java record `JitFloatEqualOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitOp for JitFloatEqualOp {
...
impl JitDefOp for JitFloatEqualOp {
...
impl JitBinOp for JitFloatEqualOp {
...
impl JitFloatBinOp for JitFloatEqualOp {}
impl JitFloatTestOp for JitFloatEqualOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::FloatEqual, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitFloatEqualOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::FloatEqual);
    }
