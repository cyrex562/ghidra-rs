//! A use-def node for a INT_NOTEQUAL p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntNotEqualOp`.
...
/// A use-def node for the [`OpCode::IntNotEqual`] p-code operation.
///
/// Port of the Java record `JitIntNotEqualOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitOp for JitIntNotEqualOp {
...
impl JitDefOp for JitIntNotEqualOp {
...
impl JitBinOp for JitIntNotEqualOp {
...
impl JitIntBinOp for JitIntNotEqualOp {}
impl JitIntTestOp for JitIntNotEqualOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntNotEqual, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntNotEqualOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntNotEqual);
    }
