//! A use-def node for a INT_SBORROW p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntSBorrowOp`.
...
/// A use-def node for the [`OpCode::IntSborrow`] p-code operation.
///
/// Port of the Java record `JitIntSBorrowOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitOp for JitIntSBorrowOp {
...
impl JitDefOp for JitIntSBorrowOp {
...
impl JitBinOp for JitIntSBorrowOp {
...
impl JitIntBinOp for JitIntSBorrowOp {}
impl JitIntTestOp for JitIntSBorrowOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntSborrow, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntSBorrowOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntSborrow);
    }
