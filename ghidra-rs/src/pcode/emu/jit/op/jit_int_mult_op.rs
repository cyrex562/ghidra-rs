//! A use-def node for a INT_MULT p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntMultOp`.
...
/// A use-def node for the [`OpCode::IntMult`] p-code operation.
///
/// Port of the Java record `JitIntMultOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitIntMultOp {
...
impl JitBinOp for JitIntMultOp {
...
impl JitIntBinOp for JitIntMultOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntMult, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntMultOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntMult);
    }
