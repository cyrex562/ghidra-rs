//! A use-def node for a ROUND p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitFloatRoundOp`.
...
/// A use-def node for the [`OpCode::FloatRound`] p-code operation.
///
/// Port of the Java record `JitFloatRoundOp(PcodeOp op, JitOutVar out, JitVal u) implements
/// JitFloatUnOp`.
///
...
#[derive(Clone)]
pub struct JitFloatRoundOp {
    op: PcodeOp,
    out: Arc<dyn JitOutVar>,
    u: Arc<dyn JitVal>,
}

impl JitFloatRoundOp {
...
impl JitOp for JitFloatRoundOp {
...
impl JitDefOp for JitFloatRoundOp {
...
impl JitUnOp for JitFloatRoundOp {
...
impl JitFloatUnOp for JitFloatRoundOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::FloatRound, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitFloatRoundOp::new(make_op(), out, u);
        assert_eq!(op.op().opcode, OpCode::FloatRound);
    }
