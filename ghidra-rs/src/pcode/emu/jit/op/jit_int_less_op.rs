//! A use-def node for a INT_LESS p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntLessOp`.
...
/// A use-def node for the [`OpCode::IntLess`] p-code operation.
///
/// Port of the Java record `JitIntLessOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitIntLessOp {
...
impl JitBinOp for JitIntLessOp {
...
impl JitIntBinOp for JitIntLessOp {}
impl JitIntTestOp for JitIntLessOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntLess, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntLessOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntLess);
    }
