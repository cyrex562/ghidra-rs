//! A use-def node for a INT_SRIGHT p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntSRightOp`.
...
use super::{JitIntBinOp};

/// A use-def node for the [`OpCode::IntSright`] p-code operation.
///
/// Port of the Java record `JitIntSRightOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
/// implements JitIntBinOp`.
///
/// # Differences from Java
///
/// Java's record automatically implements `JitIntBinOp`'s inherited default
...
impl JitDefOp for JitIntSRightOp {
...
impl JitBinOp for JitIntSRightOp {
...
impl JitIntBinOp for JitIntSRightOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntSright, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntSRightOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntSright);
    }
