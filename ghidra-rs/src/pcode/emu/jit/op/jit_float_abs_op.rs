//! A use-def node for a FLOAT_ABS p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitFloatAbsOp`.
...
/// A use-def node for the [`OpCode::FloatAbs`] p-code operation.
///
/// Port of the Java record `JitFloatAbsOp(PcodeOp op, JitOutVar out, JitVal u) implements
/// JitFloatUnOp`.
///
...
impl JitDefOp for JitFloatAbsOp {
...
impl JitUnOp for JitFloatAbsOp {
...
impl JitFloatUnOp for JitFloatAbsOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::FloatAbs, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitFloatAbsOp::new(make_op(), out, u);
        assert_eq!(op.op().opcode, OpCode::FloatAbs);
    }
