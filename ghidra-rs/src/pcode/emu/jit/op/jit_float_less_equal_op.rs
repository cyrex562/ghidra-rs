//! A use-def node for a FLOAT_LESSEQUAL p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitFloatLessEqualOp`.
...
use super::{JitFloatBinOp, JitFloatTestOp};

/// A use-def node for the [`OpCode::FloatLessEqual`] p-code operation.
///
/// Port of the Java record `JitFloatLessEqualOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
/// implements JitFloatTestOp`.
///
/// # Differences from Java
///
/// Java's record automatically implements `JitFloatTestOp`'s inherited default
...
#[derive(Clone)]
pub struct JitFloatLessEqualOp {
    op: PcodeOp,
...
impl JitOp for JitFloatLessEqualOp {
...
impl JitDefOp for JitFloatLessEqualOp {
...
impl JitBinOp for JitFloatLessEqualOp {
...
impl JitFloatBinOp for JitFloatLessEqualOp {}
impl JitFloatTestOp for JitFloatLessEqualOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::FloatLessEqual, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitFloatLessEqualOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::FloatLessEqual);
    }
    ...
    fn link_sets_definition_and_adds_uses_in_position_order() {
        ...
        let op = JitFloatLessEqualOp::new(
            make_op(),
