//! A use-def node for a INT_SREM p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntSRemOp`.
...
/// A use-def node for the [`OpCode::IntSrem`] p-code operation.
///
/// Port of the Java record `JitIntSRemOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitIntSRemOp {
...
impl JitBinOp for JitIntSRemOp {
...
impl JitIntBinOp for JitIntSRemOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntSrem, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntSRemOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntSrem);
    }
