//! A use-def node for a FLOOR p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitFloatFloorOp`.
...
/// A use-def node for the [`OpCode::FloatFloor`] p-code operation.
///
/// Port of the Java record `JitFloatFloorOp(PcodeOp op, JitOutVar out, JitVal u) implements
/// JitFloatUnOp`.
///
...
#[derive(Clone)]
pub struct JitFloatFloorOp {
    op: PcodeOp,
    out: Arc<dyn JitOutVar>,
    u: Arc<dyn JitVal>,
}

impl JitFloatFloorOp {
...
impl JitOp for JitFloatFloorOp {
...
impl JitDefOp for JitFloatFloorOp {
...
impl JitUnOp for JitFloatFloorOp {
...
impl JitFloatUnOp for JitFloatFloorOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::FloatFloor, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitFloatFloorOp::new(make_op(), out, u);
        assert_eq!(op.op().opcode, OpCode::FloatFloor);
    }
