//! A use-def node for a FLOAT_NOTEQUAL p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitFloatNotEqualOp`.
...
/// A use-def node for the [`OpCode::FloatNotEqual`] p-code operation.
///
/// Port of the Java record `JitFloatNotEqualOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitOp for JitFloatNotEqualOp {
...
impl JitDefOp for JitFloatNotEqualOp {
...
impl JitBinOp for JitFloatNotEqualOp {
...
impl JitFloatBinOp for JitFloatNotEqualOp {}
impl JitFloatTestOp for JitFloatNotEqualOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::FloatNotEqual, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitFloatNotEqualOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::FloatNotEqual);
    }
