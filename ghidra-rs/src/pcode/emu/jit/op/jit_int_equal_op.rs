//! A use-def node for a INT_EQUAL p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntEqualOp`.
...
/// A use-def node for the [`OpCode::IntEqual`] p-code operation.
///
/// Port of the Java record `JitIntEqualOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitIntEqualOp {
...
impl JitBinOp for JitIntEqualOp {
...
impl JitIntBinOp for JitIntEqualOp {}
impl JitIntTestOp for JitIntEqualOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntEqual, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntEqualOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntEqual);
    }
