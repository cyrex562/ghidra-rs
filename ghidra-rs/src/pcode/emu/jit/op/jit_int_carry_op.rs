//! A use-def node for a INT_CARRY p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntCarryOp`.
...
/// A use-def node for the [`OpCode::IntCarry`] p-code operation.
///
/// Port of the Java record `JitIntCarryOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitIntCarryOp {
...
impl JitBinOp for JitIntCarryOp {
...
impl JitIntBinOp for JitIntCarryOp {}
impl JitIntTestOp for JitIntCarryOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntCarry, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntCarryOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntCarry);
    }
