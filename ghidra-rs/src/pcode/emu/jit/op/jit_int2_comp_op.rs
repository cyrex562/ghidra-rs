//! A use-def node for a INT_2COMP p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitInt2CompOp`.
...
/// A use-def node for the [`OpCode::Int2Comp`] p-code operation.
///
/// Port of the Java record `JitInt2CompOp(PcodeOp op, JitOutVar out, JitVal u) implements
/// JitIntUnOp`.
///
...
impl JitDefOp for JitInt2CompOp {
...
impl JitUnOp for JitInt2CompOp {
...
impl JitIntUnOp for JitInt2CompOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::Int2Comp, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitInt2CompOp::new(make_op(), out, u);
        assert_eq!(op.op().opcode, OpCode::Int2Comp);
    }
