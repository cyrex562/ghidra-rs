//! A use-def node for a FLOAT_DIV p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitFloatDivOp`.
...
/// A use-def node for the [`OpCode::FloatDiv`] p-code operation.
///
/// Port of the Java record `JitFloatDivOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitFloatDivOp {
...
impl JitBinOp for JitFloatDivOp {
...
impl JitFloatBinOp for JitFloatDivOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::FloatDiv, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitFloatDivOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::FloatDiv);
    }
