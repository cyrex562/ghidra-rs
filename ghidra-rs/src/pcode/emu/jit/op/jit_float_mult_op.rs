//! A use-def node for a FLOAT_MULT p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitFloatMultOp`.
...
/// A use-def node for the [`OpCode::FloatMult`] p-code operation.
///
/// Port of the Java record `JitFloatMultOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitFloatMultOp {
...
impl JitBinOp for JitFloatMultOp {
...
impl JitFloatBinOp for JitFloatMultOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::FloatMult, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitFloatMultOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::FloatMult);
    }
