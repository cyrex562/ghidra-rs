//! A use-def node for a FLOAT_NAN p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitFloatNaNOp`.
...
/// A use-def node for the [`OpCode::FloatNan`] p-code operation.
///
/// Port of the Java record `JitFloatNaNOp(PcodeOp op, JitOutVar out, JitVal u) implements
/// JitFloatUnOp`.
///
/// # Note
///
...
impl JitDefOp for JitFloatNaNOp {
...
impl JitUnOp for JitFloatNaNOp {
...
impl JitFloatUnOp for JitFloatNaNOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::FloatNan, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitFloatNaNOp::new(make_op(), out, u);
        assert_eq!(op.op().opcode, OpCode::FloatNan);
    }
