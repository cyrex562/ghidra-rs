//! A use-def node for a INT_SCARRY p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntSCarryOp`.
...
/// A use-def node for the [`OpCode::IntScarry`] p-code operation.
///
/// Port of the Java record `JitIntSCarryOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitIntSCarryOp {
...
impl JitBinOp for JitIntSCarryOp {
...
impl JitIntBinOp for JitIntSCarryOp {}
impl JitIntTestOp for JitIntSCarryOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntScarry, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntSCarryOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntScarry);
    }
