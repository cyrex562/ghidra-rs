//! A use-def node for a INT_SLESS p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntSLessOp`.
...
/// A use-def node for the [`OpCode::IntSless`] p-code operation.
///
/// Port of the Java record `JitIntSLessOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitIntSLessOp {
...
impl JitBinOp for JitIntSLessOp {
...
impl JitIntBinOp for JitIntSLessOp {}
impl JitIntTestOp for JitIntSLessOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntSless, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntSLessOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntSless);
    }
