//! A use-def node for a INT_RIGHT p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntRightOp`.
...
/// A use-def node for the [`OpCode::IntRight`] p-code operation.
///
/// Port of the Java record `JitIntRightOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitDefOp for JitIntRightOp {
...
impl JitBinOp for JitIntRightOp {
...
impl JitIntBinOp for JitIntRightOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntRight, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntRightOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntRight);
    }
