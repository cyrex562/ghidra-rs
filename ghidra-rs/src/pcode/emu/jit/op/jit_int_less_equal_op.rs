//! A use-def node for a INT_LESSEQUAL p-code operation.
//!
//! Port of `ghidra.pcode.emu.jit.op.JitIntLessEqualOp`.
...
/// A use-def node for the [`OpCode::IntLessEqual`] p-code operation.
///
/// Port of the Java record `JitIntLessEqualOp(PcodeOp op, JitOutVar out, JitVal l, JitVal r)
...
impl JitOp for JitIntLessEqualOp {
...
impl JitDefOp for JitIntLessEqualOp {
...
impl JitBinOp for JitIntLessEqualOp {
...
impl JitIntBinOp for JitIntLessEqualOp {}
impl JitIntTestOp for JitIntLessEqualOp {}
...
mod tests {
    ...
    fn make_op() -> PcodeOp {
        ...
        PcodeOp::new(OpCode::IntLessEqual, seqnum, vec![], None)
    }
    ...
    fn has_fields() {
        ...
        let op = JitIntLessEqualOp::new(make_op(), out, l, r);
        assert_eq!(op.op().opcode, OpCode::IntLessEqual);
    }
