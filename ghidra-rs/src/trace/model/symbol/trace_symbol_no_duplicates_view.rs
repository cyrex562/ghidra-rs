...
mod tests {
    ...
    use crate::trace::seam_stubs::{
        ...
        TraceEquateManager, TraceMemoryManager, TracePlatformManager, TraceReferenceManager,
        TraceRegisterContextManager, TraceStackManager, TraceThread, TraceVariableSnapProgramView,
    };
