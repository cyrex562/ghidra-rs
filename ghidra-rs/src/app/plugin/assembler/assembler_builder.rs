...
use crate::app::seam_stubs::Assembler;
use crate::program::model::listing::Program;

use super::{AssemblySelector, GenericAssemblerBuilder};
...
///
/// [`Assembler`] is not yet ported; it's referenced through the minimal placeholder trait of the
/// same name in [`crate::app::seam_stubs`], which mirrors Java's `Assembler extends
/// GenericAssembler<AssemblyResolvedPatterns>` (an otherwise-empty marker interface) as `trait
