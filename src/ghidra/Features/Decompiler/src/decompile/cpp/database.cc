...
/// This writes a single \<z_db> tag to the stream, which contains sub-tags
...
/// The children of a \<z_db> tag are examined to recover Scope and Symbol objects.
/// \param el is the \<z_db> element
